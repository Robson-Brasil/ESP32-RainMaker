...
ESP RainMaker + Manual Button control 8 Relays using ESP32 (Real time feedback + no WiFi control)
Autor : Robson Brasil
Versão : 1
...
#include "WiFi.h"
#include "WiFiProv.h"
#include <AceButton.h> //AceButton Library: https://github.com/bxparks/AceButton
using namespace ace_button;

const char *service_name = "RobsonBrasil";
const char *pop = "LoboAlfa";

// define the Device Names
char Interruptor_1[] = "Botão 1";
char Interruptor_2[] = "Botão 2";
char Interruptor_3[] = "Botão 3";
char Interruptor_4[] = "Botão 4";
char Interruptor_5[] = "Botão 5";
char Interruptor_6[] = "Botão 6";
char Interruptor_7[] = "Botão 7";
char Interruptor_8[] = "Botão 8";
...
static Switch my_switch1(Interruptor_1, &RelayPin1);
static Switch my_switch2(Interruptor_2, &RelayPin2);
static Switch my_switch3(Interruptor_3, &RelayPin3);
static Switch my_switch4(Interruptor_4, &RelayPin4);
static Switch my_switch5(Interruptor_5, &RelayPin5);
static Switch my_switch6(Interruptor_6, &RelayPin6);
static Switch my_switch7(Interruptor_7, &RelayPin7);
static Switch my_switch8(Interruptor_8, &RelayPin8);
...
void write_callback(Device *device, Param *param, const param_val_t val, void *priv_data, write_ctx_t *ctx)
{
    ...
    if(strcmp(device_name, Interruptor_1) == 0) {
    ...
    } else if(strcmp(device_name, Interruptor_2) == 0) {
    ...
    } else if(strcmp(device_name, Interruptor_3) == 0) {
    ...
    } else if(strcmp(device_name, Interruptor_4) == 0) {
    ...
    } else if(strcmp(device_name, Interruptor_5) == 0) {
    ...
    } else if(strcmp(device_name, Interruptor_6) == 0) {
    ...
    } else if(strcmp(device_name, Interruptor_7) == 0) {
    ...
    } else if(strcmp(device_name, Interruptor_8) == 0) {
...
void setup()
{
    ...
    Node my_node;    
    my_node = RMaker.initNode("ESP32 IoT - Controlando Meu Quarto");
